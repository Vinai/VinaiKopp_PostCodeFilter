...
# Magento PostCodeFilter Extension - Terms and conditions

## 1. Preamble:
This Agreement, signed on Mar 13, 2015 [hereinafter: Effective Date] governs the relationship between the user, (hereinafter: Licensee) and LICENSOR, a LICENSOR AFFILIATION whose principal place of business is 69151 Neckargemünd, Germany.(Hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using the Magento PostCodeFilter Extension (hereinafter: The Software) created and owned by Licensor, as detailed herein
...
### 2.5 With Attribution Requirements:
The source code must always retain the copyight holders name as follows:

> Vinai Kopp <contact@vinaikopp.com>
